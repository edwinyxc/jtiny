...
//import com.shuimin.jtiny.YConfig;
...
//			throws SQLException {
//
//		String temp = (String) dbProperties.get(YConfig.DB.POOL_MAX_SIZE_KEY);
//		if (temp != null) {
//			poolMaxSize = Integer.parseInt(temp);
//		}
//		logger.debug("max_pool_size ->" + poolMaxSize);
//
//		driverClass = (String) dbProperties.get(YConfig.DB.DRIVER_CLASS_KEY);
//
//		logger.debug("driver_class ->" + driverClass);
//
//		username = (String) dbProperties.get(YConfig.DB.USERNAME_KEY);
//
//		logger.debug("username ->" + username);
//
//		pass = (String) dbProperties.get(YConfig.DB.PASSWORD_KEY);
//
//		logger.debug("password ->" + pass);
//
//		url = (String) dbProperties.get(YConfig.DB.CONN_URL_KEY);
//
