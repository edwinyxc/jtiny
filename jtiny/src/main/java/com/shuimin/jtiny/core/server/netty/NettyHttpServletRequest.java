...
public class NettyHttpServletRequest implements HttpServletRequest {
	...
	public NettyHttpServletRequest(HttpRequest httpRequest, Channel channel) {
	...
	public Cookie[] getCookies() {
		if (cookieCache == null) {
			Set<org.jboss.netty.handler.codec.http.Cookie> cookies = new CookieDecoder()
					.decode(HttpHeaders.Names.COOKIE);
